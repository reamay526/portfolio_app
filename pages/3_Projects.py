...
with col1:
    ...
    <p>Python program that calculates and displays student grades.</p>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <p>Designed using HTML and CSS for personal portfolio presentation.</p>
    </div>
    """, unsafe_allow_html=True)

    st.markdown("""
    <div class="card">
    <h3>🗄️ Web-Based Database System</h3>
    <p>Developed using XAMPP, PHP, and MySQL (phpMyAdmin) with full CRUD functionality for managing records.</p>
    </div>
    """, unsafe_allow_html=True)
...
<p>Responsive web design practice using Bootstrap framework.</p>
</div>
""", unsafe_allow_html=True).card {
    background: rgba(255, 255, 255, 0.30);
    backdrop-filter: blur(10px);
    -webkit-backdrop-filter: blur(10px);
    padding: 18px;
